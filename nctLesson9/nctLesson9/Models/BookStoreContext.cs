...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=BOKA-CHAN\\MSSQLSERVER01;Database=BookStore;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A6BC08B3DE");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C207BA74BCB5");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B01B1C54C");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCF4D0F46C4");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C2EFCC897");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FABACC871C7");
